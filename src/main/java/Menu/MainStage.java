...
//Menu.MainStage must be initialized with stage
/*
...
/*public class MainStage{
    ...
    //If we want to invoke Menu.Main menu we can use this
    ...
    public Scene createSettingsScene(){
        ...
        btnStart.setOnAction((event)->{
            try {
                ...
                System.out.println("Line: 204 File: Menu.MainStage.java");
            } finally{
                primStage.hide();
            }
        });
    ...
    private void applyChanges(String resolution, String diff, boolean isFullScreen){
        ...
        switch(runnedGame){
            case SPACEINV:
                fl = new File("settings/SpaceInv.SpaceInv.cfg");
                break;
            case CHECKERS:
                fl = new File("settings/Checkers.Checkers.cfg");
                break;
            default:
                fl = null;
                System.out.println("it doesn't work, line: 197" + " File: Menu.MainStage.java");
        }
